...
You can assume the question about driiling .
Chat History:
{chat_history}
...
template = """You are an AI assistant for the drilling DPR assistance.You are given the following extracted parts of a long document and a question. Provide a conversational answer.
...
def get_text():
    ...
    input_text = st.text_input("You: ", "What was mud used in 8 1/2 hole drilling", key="input")
    return input_text
